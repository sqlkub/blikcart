      ...
      <div style={{ background: 'white', borderBottom: '1px solid #e2e8f0' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)' }}>
          {[
            ...
            <div key={i} style={{ padding: '24px 16px', textAlign: 'center', borderRight: i < 3 ? '1px solid #e2e8f0' : 'none' }}>
        ...
        <div style={{ background: 'white', borderRadius: 14, padding: '36px 40px', border: '1px solid #e2e8f0', marginBottom: 56 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
            {[
              ...
              { qty: '20 – 49 units', discount: '15% off', bg: '#fffbeb', border: '#fde68a', tag: 'Popular' },
              { qty: '50 – 99 units', discount: '20% off', bg: '#eff6ff', border: '#bfdbfe', tag: '' },
              { qty: '100+ units', discount: '30% off', bg: '#f0fdf4', border: '#bbf7d0', tag: 'Best Value' },
            ].map((t, i) => (
              <div key={i} style={{ background: t.bg, border: `1px solid ${t.border}`, borderRadius: 10, padding: '20px 16px', textAlign: 'center', position: 'relative' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 40, alignItems: 'start' }}>
          ...
          <div>
            ...
            <div style={{ background: '#1A3C5E', borderRadius: 12, padding: 24, color: 'white', marginBottom: 16 }}>
              ...
              <p style={{ fontSize: 14, color: '#94a3b8' }}>wholesale@blikcart.nl</p>
              <p style={{ fontWeight: 700, fontSize: 14, marginTop: 16, marginBottom: 4 }}>📞 Call Us</p>
              <p style={{ fontSize: 14, color: '#94a3b8' }}>+31 (0)20 123 4567</p>
              <p style={{ fontWeight: 700, fontSize: 14, marginTop: 16, marginBottom: 4 }}>🕐 Office Hours</p>
              <p style={{ fontSize: 14, color: '#94a3b8' }}>Mon–Fri, 09:00–17:00 CET</p>
            </div>
          </div>
